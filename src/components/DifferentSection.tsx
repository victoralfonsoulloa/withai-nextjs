...
function SpotlightCard({
  ...
  return (
    <div
      ...
      className={`relative flex flex-col gap-4 overflow-hidden bg-background-2 px-8 py-6 ${point.borderClass} ${isLast ? "min-[980px]:col-span-2 min-[1161px]:col-span-1" : ""}`}
      style={{
        outline: "1px dashed",
        outlineOffset: "-1px",
    ...
    >
      ...
      <div className="relative z-10 flex flex-col gap-3">
        ...
        <h3 className="font-serif text-[18px] leading-[1.4] tracking-[-0.54px] text-ink min-[980px]:text-[24px] min-[980px]:tracking-[-0.72px]">
          {point.title}
        </h3>
      </div>
      <p className="relative z-10 font-sans text-[16px] leading-[1.5] font-normal text-grey">
        {point.body}
      </p>
    </div>
  );
...
export default function DifferentSection() {
  return (
    <section className="shrink-0 bg-background px-[10px] min-[980px]:px-16">
      <div className="flex flex-col items-center gap-10 border-t border-r border-l border-border px-4 py-[42px] min-[980px]:px-8 min-[980px]:py-[58px]">
        {/* Header */}
        <h2 className="max-w-[800px] text-center font-serif text-[36px] leading-[1.2] tracking-[-1.08px] text-ink min-[980px]:text-[48px] min-[980px]:tracking-[-1.44px]">
