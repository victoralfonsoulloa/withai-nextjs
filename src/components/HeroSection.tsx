...
export default function HeroSection() {
  return (
    <section className="shrink-0 bg-[#f0eee6] px-[10px] min-[980px]:px-16">
      <div className="relative flex flex-col items-center justify-center gap-8 overflow-hidden border-r border-l border-[rgba(36,36,36,0.1)] px-4 py-[42px] min-[980px]:px-8 min-[980px]:py-[102px]">
        ...
        <div className="relative z-10 flex w-full flex-col items-center gap-4">
          ...
          <h1 className="text-center font-serif text-[40px] leading-[1.2] tracking-[-1.2px] text-[#242424] md:max-w-[811px] md:text-[56px] md:tracking-[-1.68px]">
            AI for asset managers, built with you
          </h1>
        </div>

        <p className="relative z-10 text-center font-sans text-[16px] leading-[1.5] font-normal text-[#525252] md:text-[18px]">
        ...
        <div className="relative z-10 flex w-full flex-col items-stretch gap-4 md:w-auto md:flex-row md:items-center">
          <a
            ...
            className="touch-manipulation rounded-[10px] border border-[#fcb344] bg-[#fcb344] px-6 py-3 text-center font-sans text-[16px] font-medium text-[#242424] shadow-[0px_3px_6.25px_rgba(0,0,0,0.11)] transition-all duration-150 hover:brightness-105 active:scale-[0.97] active:brightness-95"
          >
            Book a consultation
          </a>
        </div>
