...
function QuoteIcon() {
  return (
    <svg width="18" height="15" viewBox="0 0 18 15" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M0 15V9.375C0 6.875 0.604167 4.76042 1.8125 3.03125C3.02083 1.26042 4.71875 0.0416667 6.90625 0L7.5 1.25C6.35417 1.54167 5.42708 2.17708 4.71875 3.15625C4.04167 4.09375 3.67708 5.15625 3.625 6.34375H6.25V15H0ZM10.625 15V9.375C10.625 6.875 11.2292 4.76042 12.4375 3.03125C13.6458 1.26042 15.3438 0.0416667 17.5312 0L18.125 1.25C16.9792 1.54167 16.0521 2.17708 15.3438 3.15625C14.6667 4.09375 14.3021 5.15625 14.25 6.34375H16.875V15H10.625Z" fill="#242424" fillOpacity="0.2"/>
    </svg>
  );
}
